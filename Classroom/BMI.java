...
public class BMI{
  public static void main(String[] args) {
    ...
    weight = Float.parseFloat(JOptionPane.showInputDialog("Entrer your WEIGHT"));
    ...
    if (bmi < 16){
      ...
      JOptionPane.showMessageDialog(null, "You are weightunder");
    }else if (bmi < 24){
      ...
      JOptionPane.showMessageDialog(null, "You aree gravely overweight");
    }
  }
}
